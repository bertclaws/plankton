...
- **M28 record**: added
  `note: "version_skip: biome 2.3.15 does not include noExcessiveNestedTestSuites nursery rule"`,
  confirmed `pass: true`
- **M26 record**: added
  `note: "fixture uses noExplicitAny (unfixable by --unsafe) instead of unused var (auto-fixed by --unsafe)"`
